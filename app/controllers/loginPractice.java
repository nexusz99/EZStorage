...
public class loginPractice {
	...
	// JDBC driver name and database URL
	   ...
	   boolean Join(String id,String password,String name)//ȸ������
	   {
		 
		   password=Hash_MD5(password); //md5�� password�� hash
		   PreparedStatement pst;
		   try{ 
			  String str="SELECT COUNT(userID) FROM User"; //uid ������ ���� ���� �ִ� user������ ������
			  ...
			  pst=conn.prepareStatement("SELECT userID FROM User WHERE userID=?"); // id�ߺ� ã�� sql
			  pst.setString(1, id);
			  rs=pst.executeQuery();
			  if(!rs.next()) //�ߺ��� ������ ȸ������ �Ϸ�
			  {
	   ...
	   boolean login(String id,String password) //�α����Լ�
	   {
		   password=Hash_MD5(password); // md5�� password�� hash 
		   PreparedStatement pst;
		   try{
